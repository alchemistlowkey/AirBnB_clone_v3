...
def update_place(place_id):
    ...
    head_tag = ['id', 'user_id', 'city_id', 'created_at', 'updated_at']
...
def search_places():
    ...
    places = []
    for palace in list_places:
        data_palace = palace.to_dict()
        data_palace.pop('amenities', None)
        places.append(data_palace)
